...
export default function Create({ varietasList = [] }) {
        ...
        <AuthenticatedLayout>
            ...
            <div className="max-w-2xl mx-auto px-4 py-8">
                ...
                <div className="mb-8">
                    ...
                    <h1 className="text-3xl font-black text-gray-900 tracking-tight">Tambah Lahan</h1>
                    <p className="text-gray-500 mt-1 text-sm">Isi data lahan sawah Anda untuk memulai analitik pertanian.</p>
                </div>
